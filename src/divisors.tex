...
$\mathcal{A}$ 作为 $\mathcal{A}_0$-代数有限型，则 $p$ 泛闭。
\end{lemma}
...
$\Spec(A_0) \to \Spec(R)$ 泛闭。拟紧态射（见《构造》引理
...
存在性部分，因而由《概形》命题
\ref{schemes-proposition-characterize-universally-closed} 泛闭。所以
$X \to \Spec(R)$ 作为泛闭态射的复合是泛闭的。
\end{proof}
